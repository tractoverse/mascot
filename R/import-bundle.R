...
#' dataset. See [`available_bundles()`] for the list of available bundles in the specified dataset.
#' 
#' @returns An object of class [fiber::bundle] containing the streamlines for the specified bundle.
#' 
#' @export
#' @examples
